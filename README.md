...
<p align="center">
  <a href="https://aleastategies.fun"><img alt="Site" src="https://img.shields.io/badge/site-aleastategies.fun-1a8917?style=for-the-badge"></a>
...
AleaStrategies is a real-time fair-value pricing game where every plot of land is a real, stake-backed position on Solana. There are 100 plots in the world. They are unevenly distributed across four tiers — Bronze, Silver, Gold, Diamond — and they don't mint, airdrop, or expand. Once they're claimed, they're claimed, and the only way more come back to the market is when someone abandons theirs.
...
That single design choice is what separates AleaStrategies from a prediction market analytics tool. The cost of holding land is real. The cost of giving up on land is also real. Every system layered on top — markets, tribes, alliances, raids, the yield engine — is weighted by it.

> **Land you don't believe in, you don't claim. Land you do, you defend.**

Play now at **[aleastategies.fun](https://aleastategies.fun)** · Follow updates on **[@cropfun](https://x.com/cropfun)** · Read more on **[Medium](https://medium.com/@CropLandFun)**.
...
The full Anchor program lives in [`programs/aleastategies/src/`](programs/aleastategies/src/). Below is the shape of the protocol at a glance.
...
Every harvest in AleaStrategies passes through a single pure function. Multipliers compose **multiplicatively**, not additively.
...
> AleaStrategies rewards dedication out of proportion to effort. Anyone can show up. Fewer can build the structure.
...
AleaStrategies uses USDC as the primary token. There is no native governance token at launch.
...
- **Site** — [aleastategies.fun](https://aleastategies.fun)
...
<p align="center">
  <em>AleaStrategies — the world has 100 plots. There are 5 diamonds. Find yours.</em>
</p>
